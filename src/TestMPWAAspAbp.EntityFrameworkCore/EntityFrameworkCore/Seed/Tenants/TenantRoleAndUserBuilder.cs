...
namespace TestMPWAAspAbp.EntityFrameworkCore.Seed.Tenants
{
    public class TenantRoleAndUserBuilder
    {
        private readonly TestMPWAAspAbpDbContext _context;
        ...
        private void CreateRolesAndUsers()
        {
            ...
            var permissions = PermissionFinder
                .GetAllPermissions(new TestMPWAAspAbpAuthorizationProvider())
